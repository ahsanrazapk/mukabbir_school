...
class _GalleryScreenState extends State<GalleryScreen> {
                          ...
                          Expanded(
                            child: ListView(
                              ...
                              children: [
                                ...
                                galleryModelObj?.images.isNotEmpty ?? false
                                    ? ListView.builder(
                                        scrollDirection: Axis.vertical,
                                        itemCount: galleryModelObj?.images.length ?? 0,
                                        shrinkWrap: true,
                                        primary: false,
                                    ...
                                    : Utils.noDataWidget(context, AppStrings.noImagesUploaded),
                                SizedBox(
                                  height: 8,
                                ),
                              ],
  ...
  Future<GalleryModel> _fetchGalleryImages(String token) async {
    try{
      final response = await http.get(Uri.parse('${AppConstants.baseURL}/gallery'), headers: {
      ...
      throw Exception('Failed to load gallery images ${error}');
    }
  }
}
